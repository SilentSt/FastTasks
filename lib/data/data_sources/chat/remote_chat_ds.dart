...
abstract class RemoteChatDataSource extends ChopperService
  ...
  @Get(path: r'/{chatId}')
  Future<Response<ChatModel?>> getById(@Path('chatId') final String chatId);

  @Post(path: '/message')
  Future<Response<dynamic>> sendMessage(@Body() final MessageDto messageDto);

  @Get(path: r'/history/{chatId}')
  Future<Response<List<MessageModel>>> history(@Path() final String chatId);
}
