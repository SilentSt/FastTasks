...
abstract class TaskDtoCopyWith<$R> {
  ...
  $R call({String? executorId, String? title, bool? hidden, List<String>? links, String? description, String? tableId, int? duration, DateTime? dateTime, String? note, String? id, int? status});
...
class _TaskDtoCopyWithImpl<$R> extends BaseCopyWith<TaskDto, $R> implements TaskDtoCopyWith<$R> {
  ...
  @override $R call({String? executorId, String? title, bool? hidden, List<String>? links, String? description, String? tableId, int? duration, Object? dateTime = $none, Object? note = $none, Object? id = $none, Object? status = $none}) => $then(TaskDto(executorId: executorId ?? $value.executorId, title: title ?? $value.title, hidden: hidden ?? $value.hidden, links: links ?? $value.links, description: description ?? $value.description, tableId: tableId ?? $value.tableId, duration: duration ?? $value.duration, dateTime: or(dateTime, $value.dateTime), note: or(note, $value.note), id: or(id, $value.id), status: or(status, $value.status)));
}
...
abstract class TaskModelCopyWith<$R> {
  ...
  $R call({String? id, UserModel? author, UserModel? executor, String? title, String? description, DateTime? startTime, bool? hidden, List<String>? links, bool? isAuthor, bool? isExecutor, int? duration, int? status, String? note});
...
class _TaskModelCopyWithImpl<$R> extends BaseCopyWith<TaskModel, $R> implements TaskModelCopyWith<$R> {
  ...
  @override $R call({String? id, UserModel? author, UserModel? executor, String? title, String? description, DateTime? startTime, bool? hidden, List<String>? links, bool? isAuthor, bool? isExecutor, int? duration, int? status, Object? note = $none}) => $then(TaskModel(id: id ?? $value.id, author: author ?? $value.author, executor: executor ?? $value.executor, title: title ?? $value.title, description: description ?? $value.description, startTime: startTime ?? $value.startTime, hidden: hidden ?? $value.hidden, links: links ?? $value.links, isAuthor: isAuthor ?? $value.isAuthor, isExecutor: isExecutor ?? $value.isExecutor, duration: duration ?? $value.duration, status: status ?? $value.status, note: or(note, $value.note)));
}
...
class _StatusDtoCopyWithImpl<$R> extends BaseCopyWith<StatusDto, $R> implements StatusDtoCopyWith<$R> {
  ...
  @override $R call({String? id, int? status}) => $then(StatusDto(id: id ?? $value.id, status: status ?? $value.status));
}
