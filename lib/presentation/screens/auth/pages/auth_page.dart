      ...
      body: ListView(
        ...
        children: [
          ...
          Text(
            ...
            style: AppTypography.sf.s38.w600.lightGrey,
          ),
          const SizedBox(height: 15),
          Text(
            LocaleKeys.appDescription.tr(),
            style: AppTypography.sf.s20.w400.lightGrey,
            textAlign: TextAlign.center,
          ),
              ...
              Expanded(
                child: CupertinoButton(
                  ...
                  child: Text(
                    ...
                    style: AppTypography.sf.s16.lightGrey.w500,
                  ),
                ),
              ),
              Expanded(
                child: CupertinoButton(
                  ...
                  minSize: 0,
                  color: ColorName.purple.withOpacity(.6),
                  child: Text(
